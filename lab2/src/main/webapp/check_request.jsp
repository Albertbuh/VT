<%@ page import="controllers.JspDispatcher" %>
<%@ page import="controllers.UrlDispatcher" %>
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>

<jsp:useBean id="fkingListOfRequests" scope="request" type="java.util.List"/>
<html>
<head>
...
<c:forEach var="request" items="${fkingListOfRequests}">
<p>${request.period}</p>
</c:forEach>
